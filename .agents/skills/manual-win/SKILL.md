...
4. Present the small fix, proof, and results to the `$manual-team` team.
...
- Use `$manual-team` for the review. The three subagents cast the votes; the current agent stays in charge.

...
2. Read the branch diff and commits. Ground the write-up in the diff; use commit messages only where they help clear out confusion or uncertainty. Infer the intent of the PR from the diffs and the branch name.
...
5. Review the full template. Make sure that language is clear, not too formal but explains what the PR accomplished in plain-everyday speaking language. Like one human co-worker explaining their work to another.

---
name: eval-agents-md
description: Run a configured multi-turn evaluation across coding harnesses, score each result against its configured criteria, and return the configured report. Use only when the user explicitly invokes this skill.

...
test_one_brewfile_and_environment_loading() {
  ...
  assert_file_contains "$SCRIPTS_DIR/mac/install/mac-system-settings.sh" '.machine-wallpaper-white-$color_key-rgb-rotated.png' 'Mac wallpaper filename must change with its source and color'

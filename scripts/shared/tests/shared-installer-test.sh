...
test_one_brewfile_and_environment_loading() {
  ...
  assert_file_contains "$SCRIPTS_DIR/mac/install/mac-system-settings.sh" '.machine-wallpaper-$color_key-rgb-rotated.png' 'Mac wallpaper filename must change with its color'
  ...
  assert_file_contains "$SCRIPTS_DIR/mac/install/mac-system-settings.sh" 'source_path="$CONFIG_DIR/black.heic"' 'Mac wallpaper must use the tracked black source image'

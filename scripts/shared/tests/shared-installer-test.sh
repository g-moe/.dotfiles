...
test_one_brewfile_and_environment_loading() {
  ...
  assert_file_contains "$SCRIPTS_DIR/mac/install/mac-system-settings.sh" '.machine-wallpaper-white-$color_key-rgb-rotated-heavy-vignette.png' 'Mac wallpaper filename must change with its source, color, and effect'
  ...
  assert_file_contains "$SCRIPTS_DIR/mac/install/mac-system-settings.sh" "radial-gradient:white-black +level '5%,100%'" 'Mac wallpaper must use the approved heavy vignette'

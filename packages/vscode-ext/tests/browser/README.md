...
The suite has 197 cases for terminal placement, focus, lifecycle, and speed.
...
views. Both commands check all four sidebar visibility combinations. A maximized
...
id, phase, proofPath)`. Call it with `before` and `after` for cases 1–197. Pass the

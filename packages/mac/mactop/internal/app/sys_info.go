...
func thermalStateString(level thermalStateLevel) string {
	...
	case thermalStateNominal:
		return messages.Text("Metrics_ThermalNominal")
	case thermalStateModerate:
		return messages.Text("Metrics_ThermalModerate")
	case thermalStateHeavy:
		return messages.Text("Metrics_ThermalHeavy")
	case thermalStateTrapping:
		return messages.Text("Metrics_ThermalTrapping")
	case thermalStateSleeping:
		return messages.Text("Metrics_ThermalSleeping")
	default:
		return messages.Text("Metrics_ThermalUnknown")
	}
}

...
func applyOverlayConfig(sections string) {
	...
	// Populate the U.S. English section labels.
	copyToCCharBuf(unsafe.Pointer(&ccfg.label_fps), messages.Text("Overlay_FPS"), 32)
	copyToCCharBuf(unsafe.Pointer(&ccfg.label_frame), messages.Text("Overlay_FrameInfo"), 32)
	copyToCCharBuf(unsafe.Pointer(&ccfg.label_cpu), messages.Text("Overlay_CPU"), 32)
	copyToCCharBuf(unsafe.Pointer(&ccfg.label_gpu), messages.Text("Overlay_GPU"), 32)
	copyToCCharBuf(unsafe.Pointer(&ccfg.label_ane), messages.Text("Overlay_ANE"), 32)
	copyToCCharBuf(unsafe.Pointer(&ccfg.label_memory), messages.Text("Overlay_Memory"), 32)
	copyToCCharBuf(unsafe.Pointer(&ccfg.label_swap), messages.Text("Overlay_Swap"), 32)
	copyToCCharBuf(unsafe.Pointer(&ccfg.label_power), messages.Text("Overlay_Power"), 32)
	copyToCCharBuf(unsafe.Pointer(&ccfg.label_bandwidth), messages.Text("Overlay_Bandwidth"), 64)
	copyToCCharBuf(unsafe.Pointer(&ccfg.label_gpu_freq), messages.Text("Overlay_GPUFreq"), 64)
	copyToCCharBuf(unsafe.Pointer(&ccfg.label_temps), messages.Text("Overlay_Temps"), 32)
	copyToCCharBuf(unsafe.Pointer(&ccfg.label_thermal), messages.Text("Overlay_Thermal"), 32)
	copyToCCharBuf(unsafe.Pointer(&ccfg.label_fans), messages.Text("Overlay_Fans"), 32)
	copyToCCharBuf(unsafe.Pointer(&ccfg.label_network), messages.Text("Overlay_Network"), 32)
